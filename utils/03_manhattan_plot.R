...
manhattan_plot <- df_manhattan %>% 
  ...
  labs(
    caption = "*Blue line (p-value > 5e-8): Significant associations. \n* Red line (p-value < 1e-6): Suggested for mapping, not significant.\n* Some labels had to be removed due too many overlaps."
  )+
  # Modify axis
...
png(output_dir %&% "manhattan_plot.png", width=1920*2, height=1920*1.25, res=300, units="px")
